      ...
      <section id="pricing" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Pay-per-use pricing</h2>
            <p className="text-xl text-gray-600">Simple, transparent costs. Only pay for what you use.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="mt-4"><span className="text-4xl font-bold text-gray-900">₦200</span><span className="text-gray-500">/call</span></p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900">International Passport Verification</h3>
              <p className="mt-4"><span className="text-4xl font-bold text-gray-900">₦500</span><span className="text-gray-500">/call</span></p>
              <ul className="mt-6 space-y-2 text-gray-600">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Business Name Registration</h3>
              <p className="mt-4"><span className="text-4xl font-bold text-gray-900">₦40</span><span className="text-gray-500">/call</span></p>
              <ul className="mt-6 space-y-2 text-gray-600">
